...
app.use('/api/*', cors());
app.get('/', (c) => c.html(renderTextToolPage({ title: 'Meta Tag Checker', description: 'Check title, description, canonical, Open Graph, and Twitter tags.', endpoint: '/api/check', sample: '{ "title": "...", "issues": [] }', siteKey: turnstileSiteKeyFromEnv(c.env), buttonLabel: 'Analyze', toolSlug: 'meta-tag-checker' })));
